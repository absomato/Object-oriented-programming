...
class StreamEx8excel {
    public static Student[] createArrayStudent(String file) {
        String line = "";
        String cvsSplitBy = ",";
        int n = 0; // index of Student[]
        Student studArr[] = new Student[18];
        String name; boolean isMale; int hak; int ban; int score;
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                studArr[n++]=(new Student(name,isMale,hak,ban,score));
            }
    ...
    public static void main(String[] args) {
        ...
        Student[] stuArr = createArrayStudent(cvsFile);
